...
export default function ServiceContent({ slug }: Props) {
    ...
    return (
        <>
            ...
            {/* Below-content tools: CTA, brochure, all services */}
                    ...
                    <div className="bg-white border border-[#E5E5E5] rounded-[24px] p-6 flex flex-col gap-2">
                        ...
                        {Object.values(serviceDetails).map((s) => (
                            <Link
                                ...
                                className={`flex items-center gap-3 text-sm font-medium py-2 px-3 rounded-[12px] transition-colors duration-150 ${s.slug === slug
